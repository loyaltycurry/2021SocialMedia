...
1、经济学家西蒙注意到了price的论文，由此对财富分配提出了一种解释，其基础是，有钱的人已经以与他们已经拥有的成比例的速度获得了更多财富。”富人会变得更富”这种效应可以导致power-law分布。Price接受了他的方法，并将之成为“积累优势”。

一个人一个接一个地到达某个市场。第一个到达者创建一个实体（创造财富）。后续每次有人到达时都应用以下规则：
